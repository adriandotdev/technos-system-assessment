...
<body>
    ...
    <main class="container min-vh-100 d-flex align-items-center">
        ...
        <div style="max-width: 22rem; border-top: 3px solid #0d6efd;" class="container-fluid px-0 rounded-2 pt-3 shadow-sm">
            ...
            <form class="container px-3" action="">
                ...
                <div class="row my-0 gap-3">
                    <div class="col-12 input-group px-3">
                        <input required aria-required placeholder="Email" class="form-control" type="email" name="email" id="email">
                    ...
                    <div class="col-12 input-group px-3">
                        <input required aria-required="required" placeholder="Password" class="form-control" type="password" name="password" id="password">
